...
- [Simple Bash Scripting](https://github.com/ruanyf/simple-bash-scripts)
...
- [Reinforcement Learning Algorithm with Python](https://github.com/PacktPublishing/Reinforcement-Learning-Algorithms-with-Python)
